  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        key: "getCharacters",
        value: function getCharacters(page) {
          return this.http.get("https://www.breakingbadapi.com/api/characters?limit=20&offset=".concat(page));
        ...
        value: function getQuotes() {
          ...
          this.http.get('https://breakingbadapi.com/api/quotes').subscribe(function (data) {
            _this.quotes = data; //quotes stored in the array
        ...
        key: "searchQuote",
        value: function searchQuote(author) {
          var authorQuotes = []; //authorQuotes will be an array that contains the quotes that have as author the name written in the search

          var _iterator = _createForOfIteratorHelper(this.quotes),
              _step;
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              //for each quote in the array quotes
              if (quote.author.toLowerCase().includes(author.toLowerCase())) {
                //if the variable author matches with the name written
          ...
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(authorQuotes); //return this array, this will display only the quotes from that specific author
        }
      }, {
        key: "getQuote",
        ...
        key: "getDeath",
        value: function getDeath(charName) {
          return this.http.get("https://www.breakingbadapi.com/api/death-count?name=".concat(charName));
        }
      }]);
