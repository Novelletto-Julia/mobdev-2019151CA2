...
let ApiService = class ApiService {
    ...
    getQuotes() {
        ...
        this.http.get(('https://breakingbadapi.com/api/quotes')).subscribe(data => {
            this.quotes = data; //quotes stored in the array
        });
    ...
    searchQuote(author) {
        let authorQuotes = []; //authorQuotes will be an array that contains the quotes that have as author the name written in the search
