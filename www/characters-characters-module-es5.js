    ...
    */
    ...
    var CharactersPage = /*#__PURE__*/function () {
      ...
      function CharactersPage(router, api) {
        ...
        this.router = router;
        this.api = api; //Creation of an array to organize the characters taken from API

        this.characters = []; //Starting page
      ...
      _createClass(CharactersPage, [{
        ...
        value: function loadCharacters(event) {
          ...
          this.api.getCharacters(this.page).subscribe(function (data) {
            console.log('my data: ', data); //This method will separate the whole array in many pages. This pages contain the quantity of characters selected in the load more method

            _this.characters = _this.characters.concat(data);
        ...
        value: function openDetails(character) {
          var characterId = character.char_id; //the character selected is passed to the api where the char_id is look into it
